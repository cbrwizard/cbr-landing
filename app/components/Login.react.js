        ...
        renderedResult = (
          <div className={styles.login__container}>
            ...
            <fieldset className={styles.login__fieldset}>
              ...
              <button className={styles.login__button + ' ' + styles['login__button--green']}
                      onClick={this._onLoginSubmit}>Login
              </button>
            ...
            <fieldset className={styles.login__fieldset}>
              <a className={styles.login__button + ' ' + styles['login__button--green']} href="/auth/google">Login with
                Google</a>
            </fieldset>
          </div>
        );
