  ...
  render() {
    return (
      <li className={styles['topic-item']} key={this.props.id}>
        ...
        <button className={styles['topic-item__button'] + ' ' + styles['topic-item__button--increment']}
                onClick={this._onIncrement}>+
        </button>
        <button className={styles['topic-item__button'] + ' ' + styles['topic-item__button--decrement']}
                onClick={this._onDecrement}>-
        </button>
        <button className={styles['topic-item__button'] + ' ' + styles['topic-item__button--destroy']}
